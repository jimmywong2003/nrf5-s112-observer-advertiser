...
void app_beacon_init(ble_beacon_init_t * p_init)
{
        ...
        m_beacon.adv_params.properties.type        = BLE_GAP_ADV_TYPE_NONCONNECTABLE_NONSCANNABLE_UNDIRECTED;//BLE_GAP_ADV_TYPE_ADV_NONCONN_IND;
        m_beacon.adv_params.p_peer_addr = &m_beacon.beacon_addr;
        m_beacon.adv_params.filter_policy          = BLE_GAP_ADV_FP_ANY;
        //m_beacon.adv_params.p_whitelist = NULL;
        m_beacon.adv_params.interval    = p_init->adv_interval;
        m_beacon.adv_params.duration     = 0;// disable timeout
